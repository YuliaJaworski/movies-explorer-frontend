...
## Доработка проекта
```bash
1. Сократить код в компонентах путем декомпозиции.
2. Добавить кнопку 'назад' на роутах /signin, /signup, /profile.
3. Добавить кнопку проверки пароля при регистрации.
```
